/**
 * PHP source code for the WP Pilot Elementor REST API mu-plugin.
 * This gets deployed to wp-content/mu-plugins/ via cPanel.
 *
 * Endpoints created:
 *   GET  /wp-json/wp-pilot/v1/elementor/{post_id} — read widgets
 *   POST /wp-json/wp-pilot/v1/elementor/{post_id}/widget/{widget_id} — update widget
 */

/** Returns the PHP source for the mu-plugin (deployed via cPanel file API) */
export function getMuPluginContent(): string {
  return `<?php
/**
 * Plugin Name: WP Pilot — Elementor REST API
 * Description: Custom REST endpoints for reading/modifying Elementor page data.
 * Version: 1.0.0
 * Author: WP Pilot
 *
 * Endpoints:
 *   GET  /wp-json/wp-pilot/v1/elementor/{post_id}
 *   POST /wp-json/wp-pilot/v1/elementor/{post_id}/widget/{widget_id}
 *
...
add_action( 'rest_api_init', function() {
    ...
    // GET — Read all widgets from a page
